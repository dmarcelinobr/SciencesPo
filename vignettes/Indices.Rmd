...
### Saint-Laguë
The pure Sainte-Laguë formula, also known as Schepers method, uses the odd-integer divisor series (1, 3, 5, 7, ...). In this setting, the outcome produced would be the as by the Webster's divisor method.
