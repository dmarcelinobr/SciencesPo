...
### Imperiali quota
The imperial quota is obtained by quota = $\frac{v}{(s + 2)}$. For Italian elections during the 1950s the quota was a reinforced Imperiali quota version: $\frac{v}{(s + 3)}$.
