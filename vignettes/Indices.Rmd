...
### Imperiali
The Italian Imperiali divisor system has a slowly-increasing sequence (1, 1.5, 2, 2.5, 3, ...), with 0.5 difference between consecutive divisors. This is tighter than the d'Hondt divisors for which this difference is 1. The Imperiali system, like d'Hondt, is designed to encourage coalitions and secure majority governments under a PR system, but the Imperiali will be the most favourable to large parties as they will gain many seats before their quotients are reduced below those of the smaller parties.
...
### Imperiali quota
The imperial quota is obtained by quota = $\frac{v}{(s + 2)}$. For Italian elections during the 1950s the quota was $\frac{v}{(s + 3)}$.
