...
```{r Queensland-Quebec-election, echo=FALSE, cache=TRUE, message=FALSE, comment=NA}
...
```{r Queensland-election, echo=TRUE, message=FALSE, comment=NA}
# 2012 Queensland state elecion:
Queensland
```


```{r Quebec-election, echo=TRUE, message=FALSE, comment=NA}
# 2012 Quebec provincial election:
Quebec
```
