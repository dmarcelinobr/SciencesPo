...
With **SciencesPo**, one can "preview" ggplot themes by simply invoking the `PreviewTheme()` function. This will draw a predefined plot that we can combine with themes, for instance.
