...
[ggthemr](https://github.com/cttobin/ggthemr), [cowplot](https://cran.r-project.org/package=cowplot), [ggalt](https://cran.r-project.org/package=ggalt), [GGally](https://cran.r-project.org/package=GGally), and [sjPlot](https://cran.r-project.org/package=sjPlot) that can make graph decoration a lot easier.

The layers in [ggplot2](https://cran.r-project.org/package=ggplot2) are also called ‘geoms’. Once the base setup is done, you can append the geoms one on top of the other. There's a complete discussion of plot design in the outstanding reference [Cookbook for R](http://www.cookbook-r.com/Graphs/Legends_%28ggplot2%29/) that might be of your interest.

## Themes

The default **ggplot2** design has its charm, in my opinion. But, very often I don't like the gray background grid. I feel it distracts from the data. For example, see the following **ggplot2** graph with default settings on.
