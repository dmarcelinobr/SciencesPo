...
As we can see, this vector is un(ordered) in a "strange" way so to reflect the meaning of the levels that I've attributed. By `Destring` this, we should get a numeric result with the same (un)order:
...
```{r echo=TRUE, message=FALSE, fig.width=3.5, fig.height=4, fig.align="center", fig.cap= "2014 Legislative Election in Ceara (M=42)"}
...
https://github.com/brendan-r/brocks/blob/ec27d829f72eb38c01dad875fff9f7a5979f994d/R/munge.R
https://rpubs.com/chrisbrunsdon/99675
https://github.com/search?l=r&p=4&q=add+footnote+ggplot&type=Code&utf8=✓
...
```{r echo=TRUE, message=FALSE, comment=NA, ache=TRUE}
...
```{r eval=FALSE, echo=TRUE, fig.align="center", fig.height=5, fig.width=7,  message=FALSE, comment=NA}
theme_set(theme_pub())
