...
```{r one-way, echo=FALSE, message=FALSE}
...
```{r Freq, eval=FALSE, echo=FALSE, message=FALSE}
Freq(titanic, SURVIVED) 
```

To add a second, for a cross-tabulation:

```{r two-way, echo=FALSE, message=FALSE}
...
```{r highestAverages1, eval=FALSE, echo=FALSE, message=FALSE}
