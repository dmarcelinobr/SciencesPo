...
# Introduction
Fisher compared a dataset to a sample of gold ore. The finest analysis could only extract the proportion of gold contained in the ore. But a good design could yield a sample with more gold! [data = ore;   information = gold.]
...
table <- as.data.frame(x1 =c("Gender", "Age", "Socio-demographics
"),x2=c("Person"))
names(table) = c("Disturbing Variable", "Experimental Unit")
