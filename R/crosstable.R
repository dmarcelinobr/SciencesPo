...
#' @param row, col If \code{TRUE}, parameters for marginal proportions. Default is 'row' proportions.
...
#'
#' tab(ucb, admitted, gender)
#'
#' @keywords Tables Descriptive
#' @export
`tab` <- function(.data, ..., row=TRUE, col=TRUE, tests=FALSE, deparse.level = 2){
  #################################################################
  #                                                               #
