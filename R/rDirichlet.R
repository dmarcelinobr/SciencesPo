#' @title Sample from Dirichlet distribution
#' 
#' @description Generate random deviates from the Dirichlet distribution. This code was originally posted by Ben Bolker to R-News on Fri Dec 15 2000. See \url{http://www.r-project.org/nocvs/mail/r-help/2000/3865.html}. But Ben Bolker attributed the code to Ian Wilson.
#' 
